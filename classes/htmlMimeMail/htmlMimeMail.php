...
require_once(dirname(__FILE__) . CC_DS . 'mimePart.php');
...
*/
	...
	{
		$this->headers['Subject'] = html_entity_decode($subject, ENT_QUOTES, 'UTF-8');
	}
...
*/
	...
	{
		$this->headers['From'] = html_entity_decode($from, ENT_QUOTES, 'UTF-8');
	}
	...
	function send($recipients, $type = 'mail')
	{
		...
		switch ($type) {
			case 'mail':
				...
				} else { // MANY hosting companies don'e allow mail to be sent WITHOUT a valid return path

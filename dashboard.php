...
$data['avatar'] = $db->mySQLSafe($_FILES['file']['name']); 
		...
		$data['privacy'] = $db->mySQLSafe($_POST['privacy']);
		}
...
<?
require_once 'includes/left.inc.php';?>
<div class="leftSide">
<div class="tabpage" id="tabpage_5">
<? require_once 'includes/recent-activity.inc.php';?>
</div>
<div class="box3 tabpage" id="tabpage_6" style="padding-top:0">
<? require_once 'includes/donators.inc.php';?>
</div>
<div class="tabpage" id="tabpage_7">
<? require_once 'includes/rewards.inc.php';?>
</div>
<div class="tabpage" id="tabpage_8">
<? require_once 'includes/search.inc.php';?>
</div>   
<div class="tabpage" id="tabpage_9">
<? require_once 'includes/setting.inc.php';?>
</div>  
</div>

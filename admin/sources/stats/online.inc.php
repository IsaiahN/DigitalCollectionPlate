...
?>
<p class='pageTitle'>Users Online</p>
<p class="copyText">Users who have been active in the last 15 mins.</p>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="mainTable">
  <tr>
    ...
    <td width="239" nowrap="nowrap" class="tdTitle">Session Start Time</td>
    <td width="208" nowrap="nowrap" class="tdTitle">Last Click Time</td>
    <td width="176" nowrap="nowrap" class="tdTitle">IP Address</td>
    <td width="200" nowrap="nowrap" class="tdTitle">Session Length</td>
  </tr>
<?php 
if($results==TRUE) 
{
...
?>
  ...
  <tr>
	...
	<td class="<?php echo $cellColor; ?>" width="241"><a href="<?php echo $results[$i]['location']; ?>" class="txtLink"><?php echo $results[$i]['location']; ?></a></td>

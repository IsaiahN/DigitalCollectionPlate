...
if (isset($_GET['file_id']) && is_numeric($_GET['file_id'])) {
	$sql	= sprintf("SELECT * FROM %sfilemanager WHERE file_id = %d LIMIT 1", $glob['dbprefix'], $_GET['file_id']);
...
<div class="imgPreview" align="center" style="width:<?php echo $size[0];?>px; height:<?php echo $size[1];?>px;">
  <a href="javascript:window.close();">
	<img src="<?php echo sanitizeVar($file); ?>" alt="Close Window" title="Close Window" border="0" />
  </a>
</div>
<?php } else { ?>

...
class FCKeditor
{
	...
	public function __construct( $instanceName )
 	{
		...
		if($config['rteHeight']>0 ) {
			$height = $config['rteHeight'].$config['rteHeightUnit'];
		} else {
			$height = 300;
		}
		
		$this->InstanceName	= $instanceName ;
		$this->BasePath		= $glob['rootRel'].$glob['adminFolder']."includes/rte/" ;
		$this->Width		= '100%' ;
		$this->Height		= $height ;
	...
	public function CreateHtml()
	{
		...
		if ($this->off == false && $this->IsCompatible() )
		{
